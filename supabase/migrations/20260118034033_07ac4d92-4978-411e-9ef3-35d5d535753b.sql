-- Função que verifica se o limite do plano foi atingido antes de inserir ficha
...
BEGIN
  ...
  FROM planos WHERE id = v_plano_id;
...
DROP TRIGGER IF EXISTS check_ficha_limits_trigger ON fichas_visita;

-- Criar trigger antes de INSERT em fichas_visita
CREATE TRIGGER check_ficha_limits_trigger
