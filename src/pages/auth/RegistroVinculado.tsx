...
import { Loader2, ArrowLeft, Check, Building2, UserPlus } from 'lucide-react';
              ...
              <div className="space-y-6">
                ...
                {imobiliariaEncontrada && (
                  <div className="flex items-center gap-3 p-4 bg-green-500/10 border border-green-500/30 rounded-lg">
                    <Building2 className="h-10 w-10 text-green-600 flex-shrink-0" />
                    <div>
                      <p className="font-medium text-green-700 dark:text-green-400">Imobiliária encontrada!</p>
